...
    JComboBox courseidComboBox=new JComboBox(courseid);
    JTextField creditTextField=new JTextField(credit);
...
        collegeLabel.setBounds(20,420,100,70);
        timeLabel.setBounds(20,470,100,70);
        nameTextField.setBounds(180,43,165,23);
        genderComboBox.setBounds(180,93,165,23);
        coursenameComboBox.setBounds(180,143,165,23);
        courseidComboBox.setBounds(180,193,165,23);
        creditTextField.setBounds(180,243,165,23);
        passwordField.setBounds(180,293,165,23);
        collegeTextField.setBounds(180,343,165,23);
        centrenameTextField.setBounds(180,393,165,23);
        timeComboBox.setBounds(180,444,165,23);
...
                Pstatement.setString(4,courseidComboBox.getSelectedItem().toString());
                Pstatement.setString(5,creditComboBox.getSelectedItem().toString());
                Pstatement.setString(6,passwordField.getText());
                Pstatement.setString(6,collegeTextField.getText());
                Pstatement.setString(7,centrenameTextField.getText());
                Pstatement.setString(8,timeComboBox.getSelectedItem().toString());
...
            genderComboBox.setSelectedItem(" ");
            ...
            courseisComboBox.setSelectedItem(" ");
            creditComboBox.setSelectedItem(" ");
